...
(function() {
	...
	document.addEventListener("DOMSubtreeModified", function() {
		...
		if( parent.length && !$('#inner_btn').length ) {
			...
			if(currentUrl.includes("fastcup")) {
				...
				let faceit = $(`<div id="inner_btn" class="_2uQMM"><a href="${urlFaceit}" target="_blank" id="knopka" rel="noopener noreferrer" class="_33xKn _1Az77"><span>FACEIT</span></a></div>`);
